...
let g:airline#themes#material_gerl#palette = {}

" Normal mode
let s:N1 = [s:gui_dark_gray, s:gui_green, s:cterm_dark_gray, s:cterm_green]
let s:N2 = [s:gui_light_gray, s:gui_med_gray_lo, s:cterm_light_gray, s:cterm_med_gray_lo]
let s:N3 = [s:gui_green, s:gui_med_gray_hi, s:cterm_green, s:cterm_med_gray_hi]
let g:airline#themes#material_gerl#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#material_gerl#palette.normal_modified = {
...
let g:airline#themes#material_gerl#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
let g:airline#themes#material_gerl#palette.insert_modified = copy(g:airline#themes#material_gerl#palette.normal_modified)
let g:airline#themes#material_gerl#palette.insert_paste = {
      \ 'airline_a': [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_orange, ''],
      \ }

" Replace mode
let g:airline#themes#material_gerl#palette.replace = {
      ...
      \ }
let g:airline#themes#material_gerl#palette.replace_modified = copy(g:airline#themes#material_gerl#palette.insert_modified)
...
let g:airline#themes#material_gerl#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
let g:airline#themes#material_gerl#palette.visual_modified = copy(g:airline#themes#material_gerl#palette.insert_modified)

" Inactive window
let s:IA = [s:gui_light_gray, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi, '']
let g:airline#themes#material_gerl#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
let g:airline#themes#material_gerl#palette.inactive_modified = {
...
let g:airline#themes#material_gerl#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
