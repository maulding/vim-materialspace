...
let g:airline#themes#materialspace#palette = {}
...
let g:airline#themes#materialspace#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#materialspace#palette.normal_modified = {
...
let g:airline#themes#materialspace#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
let g:airline#themes#materialspace#palette.insert_modified = copy(g:airline#themes#materialspace#palette.normal_modified)
let g:airline#themes#materialspace#palette.insert_paste = {
      \ 'airline_a': [s:gui_dark_green, s:gui_orange, s:cterm_dark_green, s:cterm_orange, ''],
      \ }

" Replace mode
let g:airline#themes#materialspace#palette.replace = {
      ...
      \ }
let g:airline#themes#materialspace#palette.replace_modified = copy(g:airline#themes#materialspace#palette.insert_modified)
...
let g:airline#themes#materialspace#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
let g:airline#themes#materialspace#palette.visual_modified = copy(g:airline#themes#materialspace#palette.insert_modified)

" Inactive window
let s:IA = [s:gui_light_gray, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi, '']
let g:airline#themes#materialspace#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
let g:airline#themes#materialspace#palette.inactive_modified = {
...
let g:airline#themes#materialspace#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
